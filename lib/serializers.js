...
function serialize(proto) {
    ...
    return serializeMessageFieldDefault(proto);
}
...
function serializeMessageField(proto, obj, field) {
    ...
    for (var vIdx = 0; vIdx < value.length; vIdx++) {
        var serialized = serializer(value[vIdx], {}, field, module.exports);
...
function serializeMessageFieldDefault(proto) {
    var result = {};
...
function deserialize(obj, proto) {
    ...
    return deserializeMessage(obj, proto);
}

function deserializeMessage(obj, proto) {
    var fields = proto.$type.getChildren();
...
function deserializeMessageField(obj, proto, field) {
    ...
    return deserializer(obj[field.name], obj, value, field, module.exports);
}
...
function deserializeMessageFieldDefault(value, obj, proto, field) {
    ...
    if (!(field && field.repeated)) {
        return deserializeMessage(value, proto);
    }
    if (value.length === 0) {
        return;
    }
    var result = []
    for (var vIdx = 0; vIdx < value.length; vIdx++) {
        result.push(deserializeMessage(value[vIdx], proto));
    }
    return result;
}
...
module.exports.deserializeMessageFieldDefault = deserializeMessageFieldDefault;
module.exports.serializeMessageFieldDefault = serializeMessageFieldDefault;
